          ...
          <div className="card">
            ...
            <div class="row">
              ...
              <section className="col-sm-3 m-1">
                ...
                <p className="sm text-lighter">
                  Hangar: {newAppointment.hangar_num}
                </p>
                <p className="sm text-lighter">
                  Access: {newAppointment.hangar_access}
                </p>
                <p className="sm text-lighter">
              ...
              <section className="col-sm-3 m-1">
                ...
                <p className="sm text-lighter">Phone: {newAppointment.phone}</p>
                <p className="sm text-lighter">Email: {newAppointment.email}</p>
              </section>
            </div>
          </div>
