...
function JetAFuelForm(props) {
  ...
  // date formatting. the project saves dates to the db in ISO8601 format for their
  // universal use cases. Otherwise, date-fns and moment are used to format the dates for 
  // readability.
